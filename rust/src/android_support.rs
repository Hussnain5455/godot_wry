...
wry::android_binding!(com_hussnain5455_godot_1wry, godot_wry);
...
pub unsafe extern "system" fn Java_com_hussnain5455_godot_1wry_WryActivity_initializeWry(
    ...
    ndk_context::initialize_android_context(vm_ptr, activity_raw as *mut _);
    
    let looper = ndk::looper::ThreadLooper::for_thread()
        .unwrap_or_else(|| ndk::looper::ThreadLooper::prepare());
